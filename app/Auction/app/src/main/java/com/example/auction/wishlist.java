...
//        url1 ="http://"+sh.getString("ip", "") + ":5000/search_view";
        ...
        url ="http://"+sh.getString("ip", "") + ":5000/viewprodct2";
        RequestQueue queue = Volley.newRequestQueue(wishlist.this);
...
//                    ls.setHorizontalScrollBarEnabled(false);
                    ...
                    gw.setAdapter(new customwishlist(wishlist.this,img,pro,price,pid));
//                    ls.setOnItemClickListener(userhome.this);

                } catch (Exception e) {
                    Toast.makeText(wishlist.this, "err===="+e, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(wishlist.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
