...
public class bid extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener,AdapterView.OnItemClickListener {
    BottomNavigationView bottomNavigationView;
    ListView ls;
    String url;
    ArrayList<String>pro,img,stprice,bprice,pid,status;
...
//        bottomNavigationView.setOnNavigationItemSelectedListener(sold_product.this);
        ...
        url ="http://"+sh.getString("ip", "") + ":5000/wonproduct";
        RequestQueue queue = Volley.newRequestQueue(bid.this);
...
//                    lv.setAdapter(ad);
                    ...
                    ls.setAdapter(new custombid(bid.this,img,pro,stprice,bprice,pid,status));
                    ls.setOnItemClickListener(bid.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(bid.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
