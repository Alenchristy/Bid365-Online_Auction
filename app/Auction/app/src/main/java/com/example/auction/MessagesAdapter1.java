...
public class MessagesAdapter1 extends ArrayAdapter<ChatMessage> {

	private static SimpleDateFormat dateFormat = new SimpleDateFormat(
			"HH:mm:ss", Locale.US);
	public MessagesAdapter1(Context context) {
		super(context, R.layout.row_message1);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.labelTime.setText(messageToShow.getTime());
