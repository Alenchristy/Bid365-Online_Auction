...
public class sell extends AppCompatActivity implements AdapterView.OnItemClickListener, BottomNavigationView.OnNavigationItemSelectedListener {
    BottomNavigationView bottomNavigationView;
    Button b;
    ListView ls;
    String url;
    ArrayList<String>pro,img,price,pid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(sell.this);
...
//                    Toast.makeText(sell.this, ""+response, Toast.LENGTH_SHORT).show();
                    ...
                    ls.setAdapter(new CustomSell(sell.this,img,pro,price,pid));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(sell.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
